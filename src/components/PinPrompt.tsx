...
export const PinPrompt = ({ amount, currencySymbol = "₹", onSuccess, onCancel }: PinPromptProps) => {
  ...
  if (showReset) {
    return (
      <div className="fixed inset-0 z-[80] bg-slate-950/95 backdrop-blur-md p-6 animate-in slide-in-from-bottom-full duration-300 overflow-y-auto">
        <button 
        ...
        <div className="flex flex-col items-center py-8 max-w-sm mx-auto w-full min-h-full">
...
return (
    <div className="fixed inset-0 z-[70] bg-slate-950/95 backdrop-blur-md p-6 animate-in slide-in-from-bottom-full duration-300 overflow-y-auto">
      <button 
        onClick={onCancel}
